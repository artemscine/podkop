...
function createConfigSection(section, map, network) {
    ...
    o = s.taboption('basic', form.DynamicList, 'domain_list', _('Service List'), _('Select predefined service for routing') + ' <a href="https://github.com/artemscine/allow-domains" target="_blank">github.com/artemscine/allow-domains</a>');
